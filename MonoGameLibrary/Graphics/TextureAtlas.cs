...
public class TextureAtlas
{
    ...
    // Get / Set source texture represented by the atlas
    public  Texture2D Texture { get; set; }

    /// <summary>
    /// Creates new texture atlas
    /// </summary>
    public TextureAtlas()
    {
    ...
    /// <summary>
    /// Creates new texture atlas using given texture
    /// </summary>
    /// <param name="texture">Source texture to be used by atlas</param>
